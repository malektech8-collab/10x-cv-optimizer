...
export const Blog: React.FC<BlogProps> = ({ lang, setLang }) => {
    ...
    return (
        <Layout lang={lang} onLanguageChange={setLang}>
            <div className="max-w-5xl mx-auto py-24 px-4 space-y-12 animate-fade-in" dir={t.dir}>
                <div className="text-center space-y-6">
                    ...
                    <h1 className="text-6xl md:text-7xl font-black text-[#4D2B8C] tracking-tight">Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#85409D] to-[#EEA727]">Blog</span></h1>
                    <p className="text-xl text-slate-500 max-w-2xl mx-auto font-medium leading-relaxed">
                        Tips, tricks, and industry secrets to beat the ATS and land your dream job.
                    </p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-32 bg-white rounded-[3rem] border border-slate-100 shadow-xl">
                        ...
                        <h3 className="text-2xl font-black text-slate-400">No Articles Yet</h3>
                        <p className="text-slate-400 font-bold mt-2">Check back soon for new content!</p>
                    </div>
                ) : (
